...
const apiLimiter = rateLimit({
  ...
  legacyHeaders: false,
  message: {
    status: RESPONSE_STATUS?.ERROR ?? "error",
...
/**
 * Restricts login attempts from a single IP address to prevent brute-force attacks.
 */
...
/**
 * Restricts login attempts for a specific account email.
 */
...
/**
 * Prevents mass account creation from a single IP address.
 */
...
/**
 * Restricts registration attempts using the same email address.
 */
